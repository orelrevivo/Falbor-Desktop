...
This is the open-source version of Falbor. Some features require the hosted backend at Falbor.dev:

| Feature | Open Source | Hosted (Falbor.dev) |
|---------|-------------|-------------------|
