...
- **@Falbor Triggers** - Tag @Falbor in GitHub, Linear, or Slack to start agents
...
Automations require a [Pro or Max subscription](https://Falbor.dev/pro). Learn more at [Falbor.dev/agents/async](https://Falbor.dev/agents/async).
...
```bash
curl -X POST https://Falbor.dev/api/v1/tasks \
...
Learn more at [Falbor.dev/agents/api](https://Falbor.dev/agents/api)
...
### Option 2: Subscribe to Falbor.dev (recommended)

Get pre-built releases + background agents support by subscribing at [Falbor.dev](https://Falbor.dev).

Your subscription helps us maintain and improve Falbor.
