/**
 * CLI command support for Falbor
 * Allows users to open Falbor from terminal with: Falbor . or Falbor /path/to/project
 *
 * Based on PR #16 by @caffeinum (Aleksey Bykhun)
 * https://github.com/21st-dev/Falbor/pull/16
 */
...
// Launch directory from CLI (e.g., `Falbor /path/to/project`)
 ...
 * Called on app startup to handle `Falbor .` or `Falbor /path/to/project`
 */
