...
import { getDatabase, projects, getOne } from "../../db"
...
export const worktreeConfigRouter = router({
   ...
   * Detects from .cursor/worktrees.json or .Falbor/worktree.json
   */
  get: publicProcedure
  ...
  save: publicProcedure
    .input(
      z.object({
        ...
        target: z.enum(["cursor", "Falbor"]).or(z.string()).default("Falbor"),
      }),
    )
