...
export function AgentModelSelector({
  ...
  // Build flat list of all models - simplified to only show GPT (Codex) models
    ...
    <Popover open={open} onOpenChange={handleOpenChange}>
      ...
      >
        <Command shouldFilter={false}>
          {/* Search removed for a cleaner simplified look with 5 models */}

          {/* Claude thinking toggle removed */}
          ...
          {selectedAgentId === "codex" && (() => {
            ...
            if (!selectedCodexModel || !selectedCodexModel.thinkings || selectedCodexModel.thinkings.length === 0) return null
            return (
              <>
          ...
          {/* Removed Add Models button as requested */}
        </Command>
      </PopoverContent>

      <CrossProviderConfirmDialog
        isOpen={confirmDialogOpen}
        providerName={pendingProvider === "codex" ? "GPT" : "Claude Code"}
